...
def ResNet_18(crypto_list: list, feature_file_dirs: list, input_channel: int, ratio=0.8, epoch=30, batch=100,
    ...
    if save_mode:
        torch.save(net, '/home/ubuntu/CryptoClassification/self_model/ResNet/' + model_name + '_model.pkl')  # todo
        model_name = model_name + '_model.pkl'
    else:
        torch.save(net.state_dict(), '/home/ubuntu/CryptoClassification/self_model/ResNet/' + model_name + '_parameter.pkl')  # todo
...
if __name__ == '__main__':
    ResNet_18(['3DES', 'AES', 'Blowfish', 'RSA'],
              ['../static/feature/3DES_ones.csv', '../static/feature/AES_ones.csv',
               '../static/feature/Blowfish_ones.csv', '../static/feature/RSA_ones.csv'],
              input_channel=1024, loss_function='CE', optimizer='Adam', col_name=['data_frame'], batch=2000, epoch=13)
