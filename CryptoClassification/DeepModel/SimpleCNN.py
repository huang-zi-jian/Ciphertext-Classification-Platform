...
def SCNN(crypto_list: list, feature_file_dirs: list, input_channel: int, ratio=0.8, epoch=30, batch=100,
    ...
    model_name = 'SCNN_' + cl
    if save_mode:
        torch.save(SCNN, '/home/ubuntu/CryptoClassification/self_model/SCNN/' + model_name + '_model.pkl')
        model_name = model_name + '_model.pkl'
    else:
        torch.save(SCNN.state_dict(), '/home/ubuntu/CryptoClassification/self_model/SCNN/' + model_name + '_parameter.pkl')
...
if __name__ == '__main__':
    # for l in thelist:
    #     SCNN(l, 1024, col_name='data_frame',
    #          loss_function='EC', optimizer='Adam', batch=200, epoch=30, save_mode=False)
