...
def SRNN(crypto_list: list, feature_file_dirs: list, input_channel: int, ratio=0.8, epoch=30, batch=100,
    ...
    model_name = 'SRNN_' + cl
    if save_mode:
        torch.save(net, '/home/ubuntu/CryptoClassification/self_model/SRNN/' + model_name + '_model.pkl')  # todo
        model_name = model_name + '_model.pkl'
    else:
        torch.save(net.state_dict(), '/home/ubuntu/CryptoClassification/self_model/SRNN/' + model_name + '_parameter.pkl')  # todo
