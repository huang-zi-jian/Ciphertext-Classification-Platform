...
def get_feature(file_list: list, crypto_name: str):
    ...
    """
    feature_list = []
    feature_file_dir = '/home/ubuntu/CryptoClassification/static/feature/' + crypto_name + '_ones.csv'
...
def load_and_test(model_name: str, file_list: list, args):
    ...
    if args.save_mode == 'para':
        ...
        model.load_state_dict(torch.load('/home/ubuntu/CryptoClassification/trained_model/' + model_name + '/' + model_name + '_' + concat2str(
            args.crypto_list) + '_parameter.pkl'))

    else:
        model = torch.load(
            '/home/ubuntu/CryptoClassification/trained_model/' + model_name + '/' + model_name + '_' + concat2str(args.crypto_list) + '_model.pkl')
    ...
    # save_verify_result(model_name, args.crypto_list, result)  # 可以保存训练的一些信息
...
def train_and_test(model_name, crypto_file_lists: dict, args):
    ...
    return '/home/ubuntu/CryptoClassification/verify_result/' + model_name + '/' + pic_dir, \
           '/home/ubuntu/CryptoClassification/self_model/' + model_name + '/' + model_dir, \
           tr_accuracy
